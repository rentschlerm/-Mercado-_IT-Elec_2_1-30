...
public class Pizza {
    ...
    public static String[] pizzaDetails = {
            ...
            "Creamy garlic Parmesan sauce, grilled chicken, apple-wood smoked bacon and diced Roma tomatoes—flavored up with toasted Parmesan on the crust edge. Best on our Hand Tossed crust."
    };
}
